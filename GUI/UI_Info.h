...
struct UI_Info	//User Interface Info.
{
	...
	static const int	width = 1000 ,height = 700 ,	//Window width and height
		...
		ToolItemWidth = 55;		//Width of each item in toolbar menu
	...
	static const int	AND2_Width = 50,		//AND2 Gate Image default width
		...
		NAND2_Height = 50,
		NAND2_Width = 50,		//AND2 Gate Image default width
